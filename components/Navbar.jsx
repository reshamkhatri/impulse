...
/* wa.me wants the number in full international form with no +, spaces or
   dashes: +977 9707505161 -> 9779707505161. `text` pre-fills the first
   message so the visitor doesn't have to open with a blank thread. */
const WHATSAPP_NUMBER = '9779707505161';
const WHATSAPP_URL =
  `https://wa.me/${WHATSAPP_NUMBER}?text=` +
  encodeURIComponent('Hi Impulse, I would like to know more about your services.');
...
export default function Navbar() {
  ...
  // On the home page this is an in-page anchor; elsewhere it's a route hop.
    ...
    <>
      ...
      <header className="header" id="navbar">
        <div className="nav-container">
          ...
          <nav className="nav-menu">
            ...
            {/* startsWith so an individual article keeps the nav item lit */}
            <Link href="/blog" className={navLink(pathname.startsWith('/blog'))}>Blogs &amp; Articles</Link>
          </nav>

          {/* Actions Block */}
          <div className="nav-actions">
            {/* Opens a WhatsApp thread with us. Stays visible below 560px,
                where .contact-btn hides, so there's always a one-tap way to
                reach someone. */}
            <a
              href={WHATSAPP_URL}
      ...
      <div className="mobile-menu" id="mobile-menu" aria-hidden="true">
        <nav className="mobile-menu-nav">
          ...
          <Link href="/blog" className="mobile-link">Blogs &amp; Articles</Link>
