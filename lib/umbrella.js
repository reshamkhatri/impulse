...
export function initUmbrella(host) {
  ...
  const Q = LITE
    ? { physical: false, bump: false, texSize: 256, radialSeg: 16, angularSeg: 12,
        tubeRadial: 5, hemSeg: 20, seamSeg: 12, ribSeg: 16, strutSeg: 8,
        pixelRatio: 1.25, envSamples: 0.06, frameMs: 1000 / 30 }
